...
public class database {
    ...
    public static int[] Coins= {0,0,0};//coins ¢5,¢10,¢25，，如果選擇終止交易，要把錢還原退回 ¢1 = $0.01
    public static int[] CoinChange= {0,0,0}; // coin out from vending machine after purchase success
    public static String[] ProductName={
            ...
            ,"G. 多力多滋             "//這裏不要改
            ,"H. 品客洋芋片         "};//這裏不要改
    public static int[] Product={0,0,0,0,0,0,0,0};//product數量, 有8個
